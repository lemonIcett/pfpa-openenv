...
class PFPAGrader:
    ...
    Final reward is clipped to [0.0, 1.0].
    Cumulative reward is capped at 0.95 to ensure scores stay strictly in (0, 1).
    """

    # Maximum cumulative reward - kept strictly below 1.0 for validator compliance
    MAX_CUMULATIVE_REWARD = 0.95
    ...
    def grade(
        ...
        # Cap cumulative reward at MAX_CUMULATIVE_REWARD (0.95) to ensure strictly < 1.0
